...
description: "A useful user proxy should not imitate a plausible person. It should make bounded, traceable inferences from real participant data and show where the evidence ends."
date: 2026-05-13
---
...
Despite the substantial criticism, this space is still active because of genuine, unmet research needs. In a [previous blog post](https://guanjie.li/Thinking-out-louder/2026/05/06/reading-the-landscape.html), I named prospective research as one example of such needs: users cannot meaningfully answer questions about experiences that have no current referent.
